...
import { Scene3D, HoverCameraController, Engine3D, AtmosphericComponent, Object3D, Camera3D, Vector3, View3D, DirectLight, KelvinUtil, LitMaterial, MeshRenderer, BoxGeometry, CameraUtil, SphereGeometry, Color, Object3DUtil, BlendMode, clamp, Matrix4, ShadowMapPassRenderer } from "@orillusion/core";
...
class Sample_CSM {
    ...
    loop() {
        ...
        this.boxRenderer.object3D.scaleZ = viewCamera.far * 2;

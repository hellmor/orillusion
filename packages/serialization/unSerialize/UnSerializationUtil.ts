...
export class UnSerializationUtil {
    ...
    public static unSerialize(instance: any, data: SerializeIndex, assets: UnSerializeData) {
        ...
        if (util) {
            ...
            instance = this.unSerialize2(instance, data, assets);
        }
        return instance;
    }

    public static unSerialize2(instance: any, data: any, assets: UnSerializeData) {
        for (const key in data) {
            this.unSerializeNode(instance, data, key, assets);
        }
        return instance;
    }

    public static unSerializeNode(instance: any, data: any, property: string, assets: UnSerializeData) {
